...
import static com.makbanteng.mychet.Utils.getImgURL;

public class SharedPreference {

    private static final String APP_PREFS_NAME = "VPNhubPreference";
    ...
    public Server getServer() {
        String country =  mPreference.getString(SERVER_COUNTRY, null);

        if(country == null) return null;
        Server server = new Server(
                mPreference.getString(SERVER_COUNTRY,"BEST VPN SERVER"),
                mPreference.getString(SERVER_FLAG,getImgURL(R.drawable.ic_signal_full)),
